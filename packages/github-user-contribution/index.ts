 ...
 *
 * @example
 *  getGithubUserContribution("RS-SaJiD", { from: "2019-01-01", to: "2019-12-31" })
 *  getGithubUserContribution("RS-SaJiD", { year: 2019 })
 *
 */
export const getGithubUserContribution = async (
  ...
  const res = await fetch("https://api.github.com/graphql", {
    headers: {
      ...
      "User-Agent": "261979776+RS-SaJiD@users.noreply.github.com",
    },
    method: "POST",
