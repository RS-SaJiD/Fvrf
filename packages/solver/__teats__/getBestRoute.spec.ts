...
import { Color, createEmptyGrid, setColor } from "@snake/types/grid";
import { createSnakeFromCells, snakeToCells } from "@snake/types/snake";
...
it("should find best route", () => {
  ...
  const chain = getBestRoute(grid, createSnakeFromCells(snake0))!;
