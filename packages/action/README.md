...
It's published to [dockerhub](https://hub.docker.com/r/robinsonsajid/snake) which makes for faster build ( compare to building the image when the action runs )
